...
const proposalsModel = {
  ...
  createProposal: async (proposal) => {
    ...
    try {
      ...
      const queryText = 'INSERT INTO business_proposals(user_id, headline, overview, skills, estimated_timeline, locations, budget, roles) VALUES($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id';
      const res = await client.query(queryText, [proposal.user_id, proposal.headline, proposal.overview, proposal.skills, proposal.estimated_timeline, proposal.locations, proposal.budget, proposal.roles]);

...
function ProfileCreation({setCurrentPage}) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-20 rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] mb-8">
        ...
        <div className="flex mb-4">
          <span className="flex flex-col mr-4">
            ...
            <select {...register("education", { required: true })} id="education-input" className="block min-h-[auto] w-full rounded border bg-transparent px-3 py-[0.32rem] leading-[1.6]">

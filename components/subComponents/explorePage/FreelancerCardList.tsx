...
function FreelancerCardList({setCurrentPage, setSavedFreelancers, filteredFreelancers}) {
    ...
    <div className="mb-20">
      {filteredFreelancers.length > 0 ? (
        filteredFreelancers.slice(0, numToShow).map((freelancer) => (
          <FreelancerCard setCurrentPage={setCurrentPage} setSavedFreelancers={setSavedFreelancers}/>
        ))
      ) : (
